...
function ButtonSolid(props) {
  ...
  return (
    <>
    <button className={`klaviyo_form_trigger w-fit hover:border font-normal hover:bg-[#0066cc] hover:text-zinc-100 hover:border-zinc-400/70 px-5 py-3 rounded-full ${props.buttonMode === 'light' ? 'bg-zinc-300 text-zinc-800' : 'bg-zinc-900 text-zinc-300'} border border-transparent flex gap-4 items-center capitalize text-sm leading-none tracking-normal`}>
        <span>{props.cta}</span>
